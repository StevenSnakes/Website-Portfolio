...
<html lang="en">
    ...
    */
    ...
    header.masthead {
      ...
      text-align: center;
      color: #fff;
      background-image: url("https://assets.change.org/photos/4/bj/hp/aubjHpNkaeHmDAP-1600x900-noPad.jpg?1584731852");
      background-repeat: no-repeat;
    ...
    <body id="page-top">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="https://assets.change.org/photos/4/bj/hp/aubjHpNkaeHmDAP-1600x900-noPad.jpg?1584731852" alt="..." />
                            </a>
        ...
        <section class="page-section" id="about">
            <div class="container">
                ...
                <ul class="timeline">
                    <li>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="https://assets.change.org/photos/4/bj/hp/aubjHpNkaeHmDAP-1600x900-noPad.jpg?1584731852" alt="..." /></div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="https://assets.change.org/photos/4/bj/hp/aubjHpNkaeHmDAP-1600x900-noPad.jpg?1584731852" alt="..." />
                            <h4>Parveen Anand</h4>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="https://assets.change.org/photos/4/bj/hp/aubjHpNkaeHmDAP-1600x900-noPad.jpg?1584731852" alt="..." /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="https://assets.change.org/photos/4/bj/hp/aubjHpNkaeHmDAP-1600x900-noPad.jpg?1584731852" alt="..." /></a>
                    </div>
